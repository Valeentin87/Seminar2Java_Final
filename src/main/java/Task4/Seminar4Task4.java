...
class CreateString {
    ...
    StringBuilder SumNumbers() {
        ...
        summa.append(first_number).append(" + ").append(second_number).append(" = ").append(first_number+second_number);
        return summa;
    }

    StringBuilder DifNumbers() {
        StringBuilder difference = new StringBuilder();
        difference.append(first_number).append(" - ").append(second_number).append(" = ").append(first_number-second_number);
        return difference;
    }

    StringBuilder MultyNumbers() {
        StringBuilder multiplication = new StringBuilder();
        multiplication.append(first_number).append(" * ").append(second_number).append(" = ").append(first_number*second_number);
        return multiplication;
    }

    String AnswerString() {
        StringBuilder answer_string = SumNumbers().append("\n").append(DifNumbers()).append("\n").append(MultyNumbers());
